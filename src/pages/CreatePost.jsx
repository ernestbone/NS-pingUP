...
const CreatePost = () => {
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-b from-slate-50
  to-white"
    >
      <div className="max-w-6xl mx-auto p-6">
        ...
        >
          ...
          {/* Text Area */}
          <textarea
            className="w-full resize-none max-h-20 mt-4
            ...
            <div className="flex flex-wrap gap-2 mt-4">
              {images.map((image, i) => (
                <div key={i} className="relative group">
                  ...
                  items-center top-0 right-0 buttom-0 left-0 bg-black/40 rounded-md cursor-pointer"
                    onClick={() => {
