    ...
    >
      <div className="flex gap-4 pb-5">
        ...
        <div
          ...
          className="rounded-lg shadow-sm min-w-30 max-h-40 aspect-[3/4]
        ...
        {stories.map((story, index) => (
          ...
          transition-all duration-200 bg-gradient-to-b from-indigo-50 to-purple-600
          hover:from-indigo-700 hover:to-purple-800 active:scale-95`}
          >
            <img
              src={story.user.profile_picture}
              alt=""
              className="absolute size-8 top-3 z-10 rounded-full
            ...
            {story.media_type !== 'text' && (
              <div
                className="absolute inset-0 z-l rounded-lg
